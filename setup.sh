...
docker exec kafka kafka-topics --create --topic log-events --bootstrap-server localhost:29092 --partitions 3 --replication-factor 1 || echo "Topic may already exist"
